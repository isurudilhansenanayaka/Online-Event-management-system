      ...
      <div id="myModal" class="modal">
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <form action="action/cakeInsert.php" method="post" enctype="multipart/form-data">
              <div class="container">
    ...
    <table id="myTable">
      ...
      <?php
        ...
        while($row = mysqli_fetch_assoc($records)) {
          ...
          echo "<td>
              <form method='post' action='cakeFill.php'>
              <input type='hidden' name='id' value=".$row["EventCode"].">
              <button id=".$count." class='button1'>Edit</button>
              </form>
              <form method='post' action='action/cakeDel.php' onsubmit='return delAl()'>
              <input type='hidden' name='id' value=".$row["EventCode"].">
