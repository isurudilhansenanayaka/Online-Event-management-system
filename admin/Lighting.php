      ...
      <div id="myModal" class="modal">
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <form action="action/lightinginsert.php" method="post" enctype="multipart/form-data">
              <div class="container">
                <div class="container signin">
                  <center>
                    <h1>Insert New Lighting Event</h1>
                    <p>Please fill in this form Correctly to Insert new Lighting Event</p>
                  </center>
                </div>
                <hr>
                <center>
